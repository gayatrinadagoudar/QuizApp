        ...
        <div class="col-md-3 p-sm-1">
                ...
                <div class="col-md-9 contentContainer">
                    ...
                    <% int sid=Integer.parseInt(session.getAttribute("student_id").toString()); 
                        ...
                        String quizStartDateTime=null, quizEndDateTime=null, quizCourseName=null, quizName=null; 
                        ...
                        <h3 class="text-primary"><a class="h2" href="student_quiz_dashboard.jsp?qid=<%=qid%>&qname=<%=quizName%>"><i class="glyphicon glyphicon-chevron-left fa-sm"></i></a>&nbsp;<i class="glyphicon glyphicon-list-alt"></i> Review Answersheet </h3><hr>    
                        <div class="p-sm-5">
                            ...
                            <div class="col-sm-4">
                                <h4 class="pull-right"> Quiz Score : <%=quizObtainedMarks%> / <%=quizTotalMarks%>  </h4>
                            </div>
                            </div>
                            <hr>
                            <div id="wrap">
