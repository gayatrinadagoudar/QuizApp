    ...
    <body>
        ...
        <div class="col-md-3 p-sm-1">
                ...
                <div class="col-md-9 contentContainer">
                    ...
                    <h3 class="text-primary"><i class="fa fa-book-open"></i> Course: <%=cname%> Quizzes </h3><hr>
                    <div class="row"> 
                            ...
                            <tbody>
                                ...
                                <%
                                    try {
                                        ...
                                        String sql = "select * from quiz where course_id="+cid;
                                        ResultSet rs = stmt.executeQuery(sql);
                                        while (rs.next()) {%>
                                <tr class="table-light">
                                    <td>
                                        <a href="student_enroll_quiz.jsp?qid=<%=rs.getInt("quiz_id")%>&qname=<%=rs.getString("quiz_name")%>" class="list-group-item list-group-item-action flex-column align-items-start">
